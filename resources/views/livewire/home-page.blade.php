  ...
  <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="text-center"> <!-- Optional: text-center to center-align text/buttons -->
        ...
        <div class="mt-7 grid gap-3 w-full sm:inline-flex">
          <a class="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-amber-600 text-white hover:bg-amber-400 disabled:opacity-50 disabled:pointer-events-none" href="/products">
            Get started
            <svg class="flex-shrink-0 w-4 h-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
              <path d="m9 18 6-6-6-6" />
            </svg>
          </a>
          <a class="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none" href="{{url('contacts')}}">
            Contact Us
          </a>
        </div>
        <!-- End Buttons -->
...
<section class="py-0">
  <div class="max-w-xl mx-auto">
    <div class="text-center ">
      <div class="relative flex flex-col items-center">
        <h1 class="text-5xl font-bold"> <span class="text-blue-500"> 
          </span> </h1>
  ...
  <div class="justify-center max-w-8xl px-4 py-4 mx-auto lg:py-0">
    <div id="categories-container" class="grid grid-cols-1 gap-6 lg:grid-cols-3 md:grid-cols-2">
    ...
    <div class="grid grid-cols-1 gap-0 lg:grid-cols-2 md:grid-cols-2">
      <div class="bg-white shadow-md">
        ...
        <div class="p-5 text-center">
           <!-- <a class="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-amber-600 text-white hover:bg-amber-400 disabled:opacity-50 disabled:pointer-events-none" href="/register">
            About Us
            <svg class="flex-shrink-0 w-4 h-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
              <path d="m9 18 6-6-6-6" />
            </svg>
  ...
  <div class="max-w-6xl px-4 py-6 mx-auto lg:py-4 md:px-6">
    <div class="max-w-xl mx-auto">
      <div class="text-center ">
        ...
        <p class="mb-12 text-base text-center text-gray-500">
        Handcrafted elegance, loved by many. Read the stories of those who adore our jewelry.
        </p>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-2 ">
      <div class="py-6 bg-white rounded-md shadow">
        ...
        Highly recommend Euphoria Colombo for anyone looking for stylish and affordable jewelry! Will definitely shop again.
        </p>
        ...
        <div class="flex flex-wrap items-center justify-between pb-4 mb-6 space-x-2 border-b">
          <div class="flex items-center px-6 mb-2 md:mb-0 ">
            ...
            <div>
              <h2 class="text-lg font-semibold text-gray-900">
                Sonira Roy</h2>
              <p class="text-xs text-gray-500">Stylist</p>
            </div>
          </div>
          <p class="px-6 text-base font-medium text-gray-600"> Joined 12, SEP , 2022
          </p>
        ...
        categoriesContainer.innerHTML = categories.map(category => `
            <div class="bg-white rounded-lg shadow-md">
                ...
                <div class="p-5 text-right">
                    <a href="/products?selected_categories[0]=${category.id}" class="text-4xl font-bold tracking-tight text-gray-900">
                        ${category.name}
                    </a>
                </div>
            </div>
